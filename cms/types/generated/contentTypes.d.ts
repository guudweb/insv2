...
export interface ApiConfiguracionInicioConfiguracionInicio
  ...
  info: {
    displayName: 'ConfiguracionInicio';
  ...
  attributes: {
    ...
    afiliacionTexto: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    afiliacionTitulo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sidebarCardTexto: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    sidebarCardTitulo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFormularioFormulario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descargas: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    posicion: Schema.Attribute.Enumeration<
      ['principal', 'lateral', 'ultima-hora', 'novedad']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    tipoMedia: Schema.Attribute.Enumeration<['imagen', 'video']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    videoArchivo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPrestacionPrestacion extends Struct.CollectionTypeSchema {
  collectionName: 'prestaciones';
  info: {
    displayName: 'prestacion';
    pluralName: 'prestaciones';
    singularName: 'prestacion';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    imagenDetalle: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiSlideAfiliacionSlideAfiliacion
  extends Struct.CollectionTypeSchema {
  collectionName: 'slide_afiliacions';
  info: {
    displayName: 'SlideAfiliacion';
    pluralName: 'slide-afiliacions';
    singularName: 'slide-afiliacion';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slide-afiliacion.slide-afiliacion'
    >;
    orden: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
